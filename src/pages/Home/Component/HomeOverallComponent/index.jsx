...
export default function HomeOverallComponent(props){
    ...
    return (
        <div style={{width:`${width}px`,height:`${height}px`,color:color,fontSize:fontSize,fontWeight:fontWeight,backgroundColor:bgColor,border:'2px solid #424242'}} className='flex-center' >
