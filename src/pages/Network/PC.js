...
export default function NetworkPC() {
    return (
        <div className='home-pc'>
            ...
            <div className='flex-center bg-color-khaki' style={{width: '100vw',minWidth:'1200px'}}>
                <div className='common-width'>
                    <div className='font-color-42' style={{fontWeight: 800, fontSize: '40px', marginTop: '137px'}}>LIGHTNING NETWORK IN BIHELIX</div>
                    <div className='flex-row fl-jc-between' style={{marginTop:'80px'}}>
                        <RGBPCMainFeatures text={'BiHelix embeds the RGB protocolinto the transactions of the Lightning Network channel, establishes a series of two-way payment channels outside the blockchain, and utilizes the efficient performance of the Lightning Network to allow users to conduct fast and low-cost transactions on these channels'} img={'https://static.paraluni.org/images/infiweb/lighting_bg6.png'} textWidth={257} imgWidth={270}/>
