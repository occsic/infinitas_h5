    ...
    return (
        <div>
            ...
            <div className="zk-dec content">
                ...
                <div className="zk-text zk-mb-24 colorB">IN BIHELIX</div>
                <div className="zk-dec-text">
                    BiHelix integrates zk-SNARK into the BTC blockchain, which can add the building blocks of the verification algorithm to the entire ecosystem in the form of pre-compiled
                ...
                <div className="zk-dec-text">
                    ...
                    verification process of the BiHelix state can be turned into a small proof that can be attached to new blocks. Ensure that the state and transaction history of new blocks are
